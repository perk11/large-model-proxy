...
```jsonc
{
  ...
  "Services": [
    ...
    },
    {
      ...
      "StartupConnectionTimeoutMilliseconds": 60000,
      "RestartOnConnectionFailure": true,
      "ShutDownAfterInactivitySeconds": 600,
      "ResourceRequirements": {
        "VRAM-GPU-1": 20000,
...
7. `StartupConnectionTimeoutMilliseconds` in starting ComfyUI makes large-model-proxy wait up to 60 seconds before giving up and considering the ComfyUI startup failed (as opposed to the default value of 2 minutes).
