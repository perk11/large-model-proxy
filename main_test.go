					...
					Services: []ServiceConfig{
						{
							...
							HealthcheckCommand:              "if command -v curl >/dev/null 2>&1; then curl --fail -s \"http://localhost:2011/\"; else wget -q -S --spider -T 2 \"http://localhost:2011/\"; fi",
					...
					Services: []ServiceConfig{
						{
							...
							HealthcheckCommand:              "if command -v curl >/dev/null 2>&1; then curl --fail -s \"http://localhost:2012/\"; else wget -q -S --spider -T 2 \"http://localhost:2012/\"; fi",
							HealthcheckIntervalMilliseconds: 200,
						},
					},
				}
					...
					Services: []ServiceConfig{
						{
							...
							HealthcheckCommand:              "if command -v curl >/dev/null 2>&1; then curl --fail -s \"http://localhost:2013/\"; else wget -q -S --spider -T 2 \"http://localhost:2013/\"; fi",
							HealthcheckIntervalMilliseconds: 200,
						},
					},
				}
					...
					Services: []ServiceConfig{
						{
							...
							HealthcheckCommand:              "if command -v curl >/dev/null 2>&1; then curl --fail -s \"http://localhost:2014/\"; else wget -q -S --spider -T 2 \"http://localhost:2014/\"; fi",
							HealthcheckIntervalMilliseconds: 200,
						},
					},
				}
